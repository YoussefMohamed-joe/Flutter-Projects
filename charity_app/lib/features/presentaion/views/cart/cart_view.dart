                          ...
                          return Row(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(  
                                    ...
                                    image: DecorationImage(
                                      image: NetworkImage(state.newModel.userCarts![index].donationItemId!.productImage!),
                                      fit: BoxFit.cover,
                                    )
                                ),
                              ),
                              ...
                              Expanded(child: Column(
                                ...
                                children: [
                                 Text(state.newModel.userCarts![index].donationItemId!.tagName!,style: getheadline(color: AppColors.black),),
                                 const Gap(5),
                                 Row(children: [
                                  Text('Quantity:',style: getbody(),),
                                  const Gap(5),
                                  Text(state.newModel.userCarts![index].quantity.toString(),style: getbody(fontWeight: FontWeight.bold),),
                                 ],),
                                 const Gap(5),
                                 Row(children: [
                                  Text('Price:',style: getbody(),),
                                  const Gap(5),
                                  Text('${state.newModel.userCarts![index].totalPrice.toString()} LE',style: getbody(fontWeight: FontWeight.bold),),
                                 ],),
                                 const Gap(5),
                                 Row(children: [
                                  Text('Delete:',style: getbody(),),
                                  const Gap(10),
