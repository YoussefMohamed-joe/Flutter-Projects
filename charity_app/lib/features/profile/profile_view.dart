            ...
            children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text('View and edit profile',style: getsubheadline(fontSize: 14,decoration: true,)),
                      const Gap(30),
                    ],
                  )
                ],
              ...
              InkWell(
                ...
                child: SizedBox(
                  ...
                  height: 50,
                  child: Row(children: [
                    SvgPicture.asset('assets/list.svg',width: 30,height: 30),
                    const Gap(15),
              ...
              InkWell(
                ...
                child: SizedBox(
                  ...
                  height: 50,
                  child: Row(children: [
                    SvgPicture.asset('assets/wallet.svg',width: 30,height: 30),
                    const Gap(15),
              ...
              InkWell(
                ...
                child: SizedBox(
                  ...
                  height: 50,
                  child: Row(children: [
                    SvgPicture.asset('assets/support.svg',width: 30,height: 30),
                    const Gap(15),
