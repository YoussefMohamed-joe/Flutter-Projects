    ...
    return Scaffold(
      ...
      body: Center(
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                Text('Hello! Register to get started',style: getTitleStyle(fontSize: 30),),
                const Gap(30),
                TextFormField(
      ...
      bottomNavigationBar: Padding(
        ...
        child: Row(
          ...
          Text('Already have an account?',style: getBodyStyle(),),
          InkWell(onTap: (){
            navigateTo(context, const LoginView());
          },child: Text(' Login Now',style: getBodyStyle(color: AppColors.primary),)),
        ],),
      ),
    );
  }
